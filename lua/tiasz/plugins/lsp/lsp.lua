return {
	...
	config = function()
		...
		lspenable("emmet_language_server")
		...
		lspconfig("basedpyright", {
			settings = {
				basedpyright = {
					...
					analysis = {
						-- Ignore all diagnostics from basedpyright to let Ruff handle them,
						-- or set typeCheckingMode to "basic" for just type errors.
						typeCheckingMode = "basic",
						ignore = { "*" }, -- Optional: if you want Ruff to handle ALL linting
					},
				},
			},
		})
		lspenable("basedpyright")

		lspconfig("ruff", {
			init_options = {
				settings = {
					lint = {
						enable = true, -- use basedpyright for linting, ruff for formatting
					},
				},
			},
		})
